Scheme
{
	...
	BaseSettings
	{
		...
		Econ.Button.PresetDefaultColorFg		"Button Color"
		Econ.Button.PresetArmedColorFg			"Button Color"
		Econ.Button.PresetDepressedColorFg		"Button Color"
		...
		RadioButton.TextColor					"Button Color"
